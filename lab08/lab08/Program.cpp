...
void Program::workShow() {
	RationalNumber <int> fraction1 (8, 2);
	RationalNumber <int> fraction2 (1, 3);

	RationalNumber <int> fractionTest;
	std::cout << "initial fractions:" << '\n' << "first : 8/2, second : 1/3" << '\n' << "results:\n";
	...
	std::cout << "/\t" << fractionTest << '\n';
	fractionTest = fraction1;
	std::cout << "=\t" << "fraction1 = fraction2 = " << fractionTest << ' ' << fraction1 << '\n';
	fractionTest = fraction1;
	...
	fractionTest = fraction1;
	fractionTest *= fraction2;
	std::cout << "*=\t" << "fraction 1 = " << fraction1 << "; fraction1 *= fraction2 = " << fraction2 << '\n';
	fractionTest = fraction1;
	fractionTest /= fraction2;
	std::cout << "/=\t" << "fraction 1 = " << fraction1 << "; fraction1 /= fraction2 = " << fraction2 << '\n';
